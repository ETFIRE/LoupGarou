...
# Définition de l'ensemble des rôles (10 joueurs)
ROLES_POOL = [
    # Loups (3)
    Role("Loup Garou", Camp.LOUP, NightAction.KILL),
    Role("Loup Garou", Camp.LOUP, NightAction.KILL),
    Role("Loup Garou", Camp.LOUP, NightAction.KILL),
    
    # Villageois (7)
    Role("Voyante", Camp.VILLAGEOIS, NightAction.INVESTIGATE),
    Role("Sorcière", Camp.VILLAGEOIS, NightAction.POTION),
    Role("Chasseur", Camp.VILLAGEOIS),
    Role("Petite Fille", Camp.VILLAGEOIS),
    Role("Chef du Village", Camp.VILLAGEOIS, NightAction.VOTE_LEADER),
    Role("Simple Villageois", Camp.VILLAGEOIS),
    Role("Simple Villageois", Camp.VILLAGEOIS),
]
